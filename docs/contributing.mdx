...
Within the directory, install the projects dependencies with NPM:

```bash
npm run setup
```

You may use `yarn` or any other package manager of your choice.
...
> You also need .env file with following info for the API server.
...
> Learn more about this at [Astro](https://docs.astro.build/en/guides/data-fetching/).

Each request performs a number of tasks:
